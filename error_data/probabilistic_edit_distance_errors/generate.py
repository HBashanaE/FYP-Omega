...
test_names_path = os.path.join(dirname, '../../Data/combined all names - cleaned - test.txt')
# confussion_set_deletion_path = os.path.join(dirname, '../Error model/Inverse probaility sets/deletion_probabilities.json')
substitution_probabilities_path = os.path.join(dirname, '../../Error model/Inverse probaility sets/substitution_probabilities.json')
insertion_probabilities_path = os.path.join(dirname, '../../Error model/Inverse probaility sets/insertion_probabilities.json')
...
with open(os.path.join(dirname, 'confussion_edit_distance_errors_.csv'), 'w', encoding='utf-8') as out_file:
    out_file.write('\n'.join(original_error))

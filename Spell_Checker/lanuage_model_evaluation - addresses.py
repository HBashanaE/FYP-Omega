...
# path = join(
#     root_dirname, '../error_data/ocr_error_data/address OCR errors testing - 1.csv')
...
# with open(join(root_dirname, f"result_evaluation_language_model_ocr_{batch_size}_{n_hidden}_{n_layers}-address.json"), "w", encoding='utf-8') as outfile:
...
with open(join(root_dirname, "../error_data/probabilistic_edit_distance_errors/confussion_edit_distance_errors_addresses.csv"), "r", encoding='utf-8') as f:
...
with open(join(root_dirname, f"result_evaluation_language_model_edit_distance_{batch_size}_{n_hidden}_{n_layers}-address.json"), "w", encoding='utf-8') as outfile:
    json.dump({"results": results,
               "final_socre": {
                   "difference_avg": difference_avg/(i + 1),
                   "difference_mul": difference_mul/(i + 1),
...
with open(join(root_dirname, f"result_evaluation_language_model_random_{batch_size}_{n_hidden}_{n_layers}-address.json"), "w", encoding='utf-8') as outfile:
    json.dump({"results": results,
               "final_socre": {
                   "difference_avg": difference_avg/(i + 1),
                   "difference_mul": difference_mul/(i + 1),

...
from Spell_Checker.utils import tokenize, preprocess
...
ngram_model_path = join(root_dirname,'Language_Model/Ngram_Model/address - kn3.pickle')
...
with open(join(root_dirname, f"result_evaluation_language_model_ocr.json"), "w", encoding='utf-8') as outfile:
